...
def diagnose_investigation(
    ...
    system_context = (
        ...
        "shell command failed and suggest concrete, executable fix commands.\n\n"
        "You will receive a structured JSON object with the command, exit code, "
        "stderr, plugin info, and environment context.\n\n"
        ...
        "Confidence: <0-100>%\n\n"
        "Suggested Commands\n\n"
        "1. <actual shell command - NOT a sentence>\n"
        "2. <actual shell command>\n"
        "3. <actual shell command>\n\n"
        "CRITICAL: Each 'Suggested Commands' entry MUST be an actual executable shell command. "
        "Do NOT write sentences. For example:\n"
        "- GOOD: ls -la /path/to/directory\n"
        "- GOOD: npm install\n"
        "- GOOD: docker ps\n"
        "- BAD: 'Check the intended path' (this is a sentence, not a command)\n"
        "- BAD: 'Ensure the directory exists' (this is a sentence, not a command)\n\n"
        "Example:\n\n"
        "Root Cause\n"
        "────────────────────────────\n"
